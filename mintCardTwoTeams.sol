...
abstract contract TeamLinkCard is ERC721, ERC721URIStorage {
...
event TeamNFTCreated(address indexed owner, string tokenURI, uint tokenId); 
    ...
    function safeMint(address to, string memory uri) public  {
        ...
        emit TeamNFTCreated(msg.sender, uri, tokenId );
    }
